...
<body>
    ...
    <?php if(is_array($studentList)): foreach($studentList as $key=>$student): if(($student["apply_detail_type"]) == "经营性道路旅客运输驾驶员"): ?><!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
	<title><?php echo C('MANAGE_LOGIN');?></title>
...
<div class="content nextpage">
    ...
    <h1 style="text-align:center;">经营性道路客货运输驾驶员从业资格考试申请表</h1><br/><br/>
        <table class="table-print">
                ...
                <table class="table-print table-sub">
                    <tr>
                      <td rowspan="5" class="tdleft">考<br/>试<br/>记<br/>录</td>
                    ...
                    <tr>
                      <td align="center" colspan="2">旅客急救</td>
                      <!-- <td align="center">&nbsp;</td> -->
                      <td colspan="2">&nbsp;</td>
                      <td>&nbsp;</td>
                    </tr> 
...
<div class="content nextpage">
	<div class="container-fluid">
    <h1 style="text-align:center;">经营性道路危货运输从业资格考试申请表</h1><br/><br/>
        <table class="table-print table-fx">
                ...
                <tr>
                  ...
                  <table>
                    <tr>
                      <td width="166" rowspan="2" class="tdleft">考<br/>试<br/>记<br/>录</td>
                      <td colspan="2" align="center">成绩</td>
                      <td colspan="2" align="center">考核员</td>
                      <td width="226" align="center">考核员</td>
                    </tr>
                    <tr>
...
</html><?php endif; endforeach; endif; ?>
