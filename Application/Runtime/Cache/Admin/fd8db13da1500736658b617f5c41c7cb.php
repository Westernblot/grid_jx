...
function doDelete(){
	...
	//alert(ids);
	location.href='/jx/index.php/Admin/User/delete?ids='+ids;
}
...
function doResetPWD(){
	...
	if(confirm("重置后密码为1，确定吗？")){
	   location.href='/jx/index.php/Admin/User/resetPWD?ids='+ids;
	}
}
	...
	<div class="right_top">
				...
				<div class="title">
					...
					<div style="float: right">
						<form action="/jx/index.php/Admin/User/userList" id="formQuery" method="get">							
						用户：<input type="text" name="username" value="<?php echo ($username); ?>" />
