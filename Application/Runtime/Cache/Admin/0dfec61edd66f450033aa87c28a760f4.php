...
<style type="text/css">
 body{background:url(/jx/Public/images/sys/log_bg.jpg) repeat; }
 .m_log{background:url(/jx/Public/images/sys/log_tbg.jpg) top repeat-x #F9F9F9; border:1px solid #C8C8CA; margin:16% auto 0 auto; font-weight:bold; color:#5E5E5E;}
 .m_log input[type="text"],
 .m_log input[type="password"]{ width:90%;}
</style>
</head>
<body>
<form action="/jx/index.php/Admin/Login/login" id="form1" method="post">
<table width="400" height="240" border="0"  class="m_log">
  <tr>
  <td height="40" style="font-size:14px;background:url(/jx/Public/images/sys/user_silhouette.png) no-repeat 10px center;">　　用户登陆</td>
  </tr>
